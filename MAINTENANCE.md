...
Un repositorio se incluye porque interactúa con instituciones, servicios, infraestructura, normativas o datos propios de Cantabria. No basta con que el autor sea de Cantabria o resida aquí. Un framework genérico creado por un developer de Cantabria no pertenece a esta lista. Un cliente para una API de servicios de Cantabria sí.

# Contribuir a Awesome Cantabria
...
- El proyecto debe **dar soporte específico a Cantabria** o incluir funcionalidades relevantes para usuarios en esta comunidad autónoma.
...
5. **Incluye en la descripción de la PR la URL del servicio, API o institución cántabra** a la que el software da soporte (p.ej. cantabria.es, unican.es, icane.es). Esto ayuda a verificar que el proyecto es relevante para Cantabria.

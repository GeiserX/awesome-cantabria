...
- URL del repositorio
- URL del servicio/API/institución cántabra a la que da soporte (p.ej. cantabria.es, unican.es, icane.es)
Elimina esta sección si no aplica.
-->

| Proyecto | Servicio/Institución cántabra |
|----------|-------------------------------|
...
- URL del repositorio
- Motivo (archivado, no funcional, reemplazado, no específico de Cantabria, etc.)
Elimina esta sección si no aplica.
-->
